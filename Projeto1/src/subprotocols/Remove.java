 ...
 */
public class Remove extends SubProtocol{
    ...
    public boolean messageOwner(String id) {
        return id.equalsIgnoreCase("REMOVE");
    }

    public void validateArgs(String[] args) throws MalformedMessageException {
        if (args.length != 4)
            throw new MalformedMessageException("Wrong number of arguments for the REMOVE protocol: 4 arguments must be present");
    ...
    public String toString() {
        return "REMOVE - Version: " + version + " Sender ID: " + senderId + " File ID: " + fileId + " Chunk No " + chunkNo;
    }
}
